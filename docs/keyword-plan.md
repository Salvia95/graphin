...
| 2 M2 채점기 + 기준선 | **완료(단서 있음)** — 루브릭 1.3.1(관찰 3종), 스모크 18런 재채점, 변경 전 77/81런(429 중단, 관찰 지표만) + 프롬프트만 변경 81런(스킬 편집 뒤 재실행한 순서 실수, 대조 팔로 전용) | [2026-09-05-keyword-context](eval/2026-09-05-keyword-context/findings.md) |
