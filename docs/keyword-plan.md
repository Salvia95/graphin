...
| 4 릴리스 | **완료 — v0.4.12 (patch) + 가이드 0.6.3, 2026-09-06** — D′ 사전 기준 10 중 9 충족·db-nav 재실행 23/24를 보고 소유자가 택함. 스모크 게이트 세 번 6/6(CI 전용 커밋이 마커를 만료시켰다) | [p1-fold 후기](eval/2026-09-06-p1-fold/findings.md), [gate-log](eval/gate-log.md) |
