...
- **grep 대조군은 같은 날 돌았다** → [2026-09-08-grep-control](../2026-09-08-grep-control/findings.md).
  grep 77/81 대 graphin 74/81(승격 전 76), 부호검정 p=0.688 — 정답률 차이 없음.
  값은 바이트(32% 적음, p=0.052)와 정직성(`over_silent` 0 대 2, 자기보고 0.98 대
  0.70), 그리고 이탈 0런 대 12런이다.
