...
aliases: [usage metrics, instrumentation, discovery failure, fallback, telemetry, usage log, usage events, metric, metrics]
roles: []
prerequisites: []
mode: live
---
...
- [Phase 1이 비교 가능성을 끊었다](../../adoption.md#phase-1이-비교-가능성을-끊었다) —
...
- [권고 1 — 위치 반환](../../adoption.md#권고-1--위치-반환-구현됨) —
